...
public class ScheduleDetailActivity extends AppCompatActivity {
    ...
    //detail
    @BindView(R2.id.detail_alarm_title) TextView detail_alarm_title;
    @BindView(R2.id.detail_alarm_date) TextView detail_alarm_date;
    @BindView(R2.id.detail_alarm_start_end_time) TextView detail_alarm_start_end_time;
    @BindView(R2.id.detail_alarm_remind) TextView detail_alarm_remind;
    @BindView(R2.id.detail_alarm_local) TextView detail_alarm_local;
    @BindView(R2.id.detail_alarm_description) TextView detail_alarm_description;
    ...
    @BindView(R2.id.update_fab)
    FloatingActionButton update_fab;
    //更新修改
    @OnClick(R2.id.update_fab)void updateData(){
    ...
    @OnClick(R2.id.left_alarm_back) void back(){
    ...
    private void dialog() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() { //设置确定按钮
            ...
            public void onClick(DialogInterface dialog, int which) {
                deteleDataById(id);
                startActivity(new Intent(ScheduleDetailActivity.this, CalendarMainActivity.class));
                finish();
            }
        });
