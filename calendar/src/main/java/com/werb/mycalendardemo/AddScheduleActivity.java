...
public class AddScheduleActivity extends AppCompatActivity {
    ...
    @BindView(R2.id.sw_vibrate)
    Switch sw_vibrate;

    @OnClick(R2.id.sw_vibrate)
    void is_Vibrate() {
        Vibrator vibrator;
